    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.mainTime = reader.uint32();
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.fischerTime = reader.uint32();
          continue;
        }
        case 3: {
          if (tag !== 24) {
  ...
  fromJSON(object: any): PlayerTimeInfo {
    return {
      mainTime: isSet(object.mainTime)
        ? globalThis.Number(object.mainTime)
        : isSet(object.main_time)
        ? globalThis.Number(object.main_time)
        : 0,
      fischerTime: isSet(object.fischerTime)
        ? globalThis.Number(object.fischerTime)
        : isSet(object.fischer_time)
        ? globalThis.Number(object.fischer_time)
        : 0,
