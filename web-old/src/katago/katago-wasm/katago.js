...
function __asyncjs__js_get_output(numBatchEltsFilled, nnXLen, nnYLen, numSpatialChannels, numGlobalChannels, spatial, global, policyProbs, valueOutputs, ownerMap) {
  return Asyncify.handleAsync(async () => {
    if (typeof window !== "undefined" && window.katagoGetOutput) {
      await window.katagoGetOutput(numBatchEltsFilled, nnXLen, nnYLen, numSpatialChannels, numGlobalChannels, spatial, global, policyProbs, valueOutputs, ownerMap);
    } else if (typeof self !== "undefined" && self.katagoGetOutput) {
      await self.katagoGetOutput(numBatchEltsFilled, nnXLen, nnYLen, numSpatialChannels, numGlobalChannels, spatial, global, policyProbs, valueOutputs, ownerMap);
    } else {
      console.error("katagoGetOutput not found");
    }
  });
}
...
var dynCall_iiiiiiiid = makeInvalidEarlyAccess("dynCall_iiiiiiiid");

var dynCall_iiiiiiidi = makeInvalidEarlyAccess("dynCall_iiiiiiidi");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["dynCall_iiiiiiiid"] != "undefined", "missing Wasm export: dynCall_iiiiiiiid");
  assert(typeof wasmExports["dynCall_iiiiiiidi"] != "undefined", "missing Wasm export: dynCall_iiiiiiidi");
  ...
  dynCall_iiiiiiiid = dynCalls["iiiiiiiid"] = createExportWrapper("dynCall_iiiiiiiid", 9);
  dynCall_iiiiiiidi = dynCalls["iiiiiiidi"] = createExportWrapper("dynCall_iiiiiiidi", 9);
...
function assignWasmImports() {
  wasmImports = {
    ...
    /** @export */ __asyncjs__js_get_output,
