...
function App() {
  ...
  // gameData: { history, gameType, winner, endedByDraw, blackName, whiteName, initialBlackSec, initialWhiteSec, endedAt }
  // GamePlay에서 종료 시 onSaveHistory로 채움.
  const [gameData, setGameData] = useState({ history: [] });
    ...
    switch (currentPage) {
      case "ai_analysis":
        return (
          <AiAnalysis
            {...commonProps}
            gameType={gameData.gameType || currentGameType}
