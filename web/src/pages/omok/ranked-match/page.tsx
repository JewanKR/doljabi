...
export default function OmokRankedMatch() {
  ...
  const [receivedRequests, setReceivedRequests] = useState<Player[]>([
    { id: 5, nickname: '오목고수', rating: 1650, status: 'online', rank: 3 }
  ]);

  // 예시 플레이어 데이터
  const players: Player[] = [
    { id: 1, nickname: '오목마스터', rating: 1800, status: 'online', rank: 1 },
    { id: 2, nickname: '5목달인', rating: 1750, status: 'playing', rank: 2 },
    { id: 3, nickname: '오목고수', rating: 1650, status: 'online', rank: 3 },
    { id: 4, nickname: '프로지망생', rating: 1600, status: 'away', rank: 4 },
    { id: 5, nickname: '오목천재', rating: 1580, status: 'online', rank: 5 },
    { id: 6, nickname: '흑백대전', rating: 1550, status: 'playing', rank: 6 },
    { id: 7, nickname: '연승왕', rating: 1520, status: 'online', rank: 7 },
    { id: 8, nickname: '오목킹', rating: 1500, status: 'away', rank: 8 },
  ];
