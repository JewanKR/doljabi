...
export default function OmokWaitingRoom() {
  ...
  useEffect(() => {
    ...
    } else if (isHost && players[1].nickname === '대기 중...' && !state?.opponent) {
      const timer = setTimeout(() => {
        setPlayers(prev => [
          prev[0],
          {
  ...
  const handleStartGame = () => {
    navigate('/omok/game-room', { state: { gameSettings, players, roomCode } });
  };
        ...
        <div className="rounded-xl p-6 border mb-6"
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold" style={{ color: '#e8eaf0' }}>오목</span>
            </div>
