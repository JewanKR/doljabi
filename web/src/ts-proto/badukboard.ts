...
export const BadukBoardState: MessageFns<BadukBoardState> = {
    ...
    fromJSON(object: any): BadukBoardState {
        return {
            black: globalThis.Array.isArray(object?.black)
                ? object.black.map((e: any) => BigInt(e))
                : [],
            white: globalThis.Array.isArray(object?.white)
                ? object.white.map((e: any) => BigInt(e))
                : [],
        };
    },
    ...
    create<I extends Exact<DeepPartial<BadukBoardState>, I>>(
        base?: I,
    ): BadukBoardState {
        return BadukBoardState.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<BadukBoardState>, I>>(
        object: I,
    ): BadukBoardState {
        const message = createBaseBadukBoardState();
...
export const PlayerTimeInfo: MessageFns<PlayerTimeInfo> = {
    encode(
        ...
        if (message.mainTime !== 0n) {
            if (BigInt.asUintN(64, message.mainTime) !== message.mainTime) {
                throw new globalThis.Error(
                    "value provided for field message.mainTime of type uint64 too large",
                );
            }
        ...
        if (message.fischerTime !== 0n) {
            if (
                BigInt.asUintN(64, message.fischerTime) !== message.fischerTime
            ) {
                throw new globalThis.Error(
                    "value provided for field message.fischerTime of type uint64 too large",
                );
            }
        ...
        if (message.overtime !== 0n) {
            if (BigInt.asUintN(64, message.overtime) !== message.overtime) {
                throw new globalThis.Error(
                    "value provided for field message.overtime of type uint64 too large",
                );
            }
    ...
    create<I extends Exact<DeepPartial<PlayerTimeInfo>, I>>(
        base?: I,
    ): PlayerTimeInfo {
        return PlayerTimeInfo.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<PlayerTimeInfo>, I>>(
        object: I,
    ): PlayerTimeInfo {
        const message = createBasePlayerTimeInfo();
...
export const GameState: MessageFns<GameState> = {
    encode(
        ...
        if (message.board !== undefined) {
            BadukBoardState.encode(
                message.board,
                writer.uint32(10).fork(),
            ).join();
        }
        if (message.blackTime !== undefined) {
            PlayerTimeInfo.encode(
                message.blackTime,
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1: {
                    ...
                    message.board = BadukBoardState.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 2: {
                    ...
                    message.blackTime = PlayerTimeInfo.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 3: {
                    ...
                    message.whiteTime = PlayerTimeInfo.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
    ...
    fromJSON(object: any): GameState {
        return {
            board: isSet(object.board)
                ? BadukBoardState.fromJSON(object.board)
                : undefined,
    ...
    fromPartial<I extends Exact<DeepPartial<GameState>, I>>(
        ...
        message.board =
            object.board !== undefined && object.board !== null
                ...
                : undefined;
        message.blackTime =
            object.blackTime !== undefined && object.blackTime !== null
                ? PlayerTimeInfo.fromPartial(object.blackTime)
                : undefined;
        message.whiteTime =
            object.whiteTime !== undefined && object.whiteTime !== null
...
export const ChaksuRequest: MessageFns<ChaksuRequest> = {
    ...
    fromJSON(object: any): ChaksuRequest {
        return {
            coordinate: isSet(object.coordinate)
                ? globalThis.Number(object.coordinate)
                : 0,
        };
    },
    ...
    create<I extends Exact<DeepPartial<ChaksuRequest>, I>>(
        base?: I,
    ): ChaksuRequest {
        return ChaksuRequest.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ChaksuRequest>, I>>(
        object: I,
    ): ChaksuRequest {
        const message = createBaseChaksuRequest();
...
export const DrawOfferRequest: MessageFns<DrawOfferRequest> = {
    ...
    create<I extends Exact<DeepPartial<DrawOfferRequest>, I>>(
        base?: I,
    ): DrawOfferRequest {
        return DrawOfferRequest.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<DrawOfferRequest>, I>>(
        _: I,
    ): DrawOfferRequest {
        const message = createBaseDrawOfferRequest();
        return message;
...
export const ResignRequest: MessageFns<ResignRequest> = {
    ...
    create<I extends Exact<DeepPartial<ResignRequest>, I>>(
        base?: I,
    ): ResignRequest {
        return ResignRequest.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ResignRequest>, I>>(
        _: I,
    ): ResignRequest {
        const message = createBaseResignRequest();
        return message;
...
export const PassTurnRequest: MessageFns<PassTurnRequest> = {
    ...
    create<I extends Exact<DeepPartial<PassTurnRequest>, I>>(
        base?: I,
    ): PassTurnRequest {
        return PassTurnRequest.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<PassTurnRequest>, I>>(
        _: I,
    ): PassTurnRequest {
        const message = createBasePassTurnRequest();
        return message;
...
export const GameStartRequest: MessageFns<GameStartRequest> = {
    ...
    create<I extends Exact<DeepPartial<GameStartRequest>, I>>(
        base?: I,
    ): GameStartRequest {
        return GameStartRequest.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<GameStartRequest>, I>>(
        _: I,
    ): GameStartRequest {
        const message = createBaseGameStartRequest();
        return message;
...
export const ClientToServer: MessageFns<ClientToServer> = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 100: {
                    ...
                    message.coordinate = ChaksuRequest.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 101: {
                    ...
                    message.resign = ResignRequest.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 102: {
                    ...
                    message.drawOffer = DrawOfferRequest.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 103: {
                    ...
                    message.passTurn = PassTurnRequest.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 104: {
                    ...
                    message.gamestart = GameStartRequest.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
    ...
    fromJSON(object: any): ClientToServer {
        return {
            sessionKey: isSet(object.sessionKey)
                ...
                : "",
            coordinate: isSet(object.coordinate)
                ? ChaksuRequest.fromJSON(object.coordinate)
                : undefined,
            resign: isSet(object.resign)
                ? ResignRequest.fromJSON(object.resign)
                : undefined,
            ...
            passTurn: isSet(object.passTurn)
                ...
                : undefined,
            gamestart: isSet(object.gamestart)
                ? GameStartRequest.fromJSON(object.gamestart)
                : undefined,
        };
    },
    ...
    create<I extends Exact<DeepPartial<ClientToServer>, I>>(
        base?: I,
    ): ClientToServer {
        return ClientToServer.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ClientToServer>, I>>(
        object: I,
    ): ClientToServer {
        const message = createBaseClientToServer();
        ...
        message.coordinate =
            object.coordinate !== undefined && object.coordinate !== null
                ...
                : undefined;
        message.resign =
            object.resign !== undefined && object.resign !== null
                ? ResignRequest.fromPartial(object.resign)
                : undefined;
        message.drawOffer =
            object.drawOffer !== undefined && object.drawOffer !== null
                ? DrawOfferRequest.fromPartial(object.drawOffer)
                : undefined;
        message.passTurn =
            object.passTurn !== undefined && object.passTurn !== null
                ? PassTurnRequest.fromPartial(object.passTurn)
                : undefined;
        message.gamestart =
            object.gamestart !== undefined && object.gamestart !== null
...
export const ChaksuResponse: MessageFns<ChaksuResponse> = {
    ...
    create<I extends Exact<DeepPartial<ChaksuResponse>, I>>(
        base?: I,
    ): ChaksuResponse {
        return ChaksuResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ChaksuResponse>, I>>(
        object: I,
    ): ChaksuResponse {
        const message = createBaseChaksuResponse();
...
export const ResignResponse: MessageFns<ResignResponse> = {
    ...
    create<I extends Exact<DeepPartial<ResignResponse>, I>>(
        base?: I,
    ): ResignResponse {
        return ResignResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ResignResponse>, I>>(
        _: I,
    ): ResignResponse {
        const message = createBaseResignResponse();
        return message;
...
export const DrawOfferResponse: MessageFns<DrawOfferResponse> = {
    ...
    create<I extends Exact<DeepPartial<DrawOfferResponse>, I>>(
        base?: I,
    ): DrawOfferResponse {
        return DrawOfferResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<DrawOfferResponse>, I>>(
        object: I,
    ): DrawOfferResponse {
        const message = createBaseDrawOfferResponse();
...
export const PassTurnResponse: MessageFns<PassTurnResponse> = {
    ...
    create<I extends Exact<DeepPartial<PassTurnResponse>, I>>(
        base?: I,
    ): PassTurnResponse {
        return PassTurnResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<PassTurnResponse>, I>>(
        _: I,
    ): PassTurnResponse {
        const message = createBasePassTurnResponse();
        return message;
...
export const UserInfo: MessageFns<UserInfo> = {
    ...
    fromPartial<I extends Exact<DeepPartial<UserInfo>, I>>(
        object: I,
    ): UserInfo {
        const message = createBaseUserInfo();
        message.userName = object.userName ?? "";
...
export const GameStartResponse: MessageFns<GameStartResponse> = {
    ...
    create<I extends Exact<DeepPartial<GameStartResponse>, I>>(
        base?: I,
    ): GameStartResponse {
        return GameStartResponse.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<GameStartResponse>, I>>(
        _: I,
    ): GameStartResponse {
        const message = createBaseGameStartResponse();
        return message;
...
export const UsersInfo: MessageFns<UsersInfo> = {
    ...
    fromJSON(object: any): UsersInfo {
        return {
            black: isSet(object.black)
                ? UserInfo.fromJSON(object.black)
                : undefined,
            white: isSet(object.white)
                ? UserInfo.fromJSON(object.white)
                : undefined,
        };
    },
    ...
    fromPartial<I extends Exact<DeepPartial<UsersInfo>, I>>(
        object: I,
    ): UsersInfo {
        const message = createBaseUsersInfo();
        message.black =
            object.black !== undefined && object.black !== null
                ? UserInfo.fromPartial(object.black)
                : undefined;
        message.white =
            object.white !== undefined && object.white !== null
...
export const ServerToClient: MessageFns<ServerToClient> = {
    encode(
        ...
        if (message.coordinate !== undefined) {
            ChaksuResponse.encode(
                message.coordinate,
                writer.uint32(802).fork(),
            ).join();
        }
        if (message.resign !== undefined) {
            ResignResponse.encode(
                message.resign,
                writer.uint32(810).fork(),
            ).join();
        }
        if (message.drawOffer !== undefined) {
            DrawOfferResponse.encode(
                message.drawOffer,
                writer.uint32(818).fork(),
            ).join();
        }
        if (message.passTurn !== undefined) {
            PassTurnResponse.encode(
                message.passTurn,
                writer.uint32(826).fork(),
            ).join();
        }
        if (message.gameStart !== undefined) {
            GameStartResponse.encode(
                message.gameStart,
                writer.uint32(834).fork(),
            ).join();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4: {
                    ...
                    message.gameState = GameState.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 5: {
                    ...
                    message.usersInfo = UsersInfo.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 100: {
                    ...
                    message.coordinate = ChaksuResponse.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 101: {
                    ...
                    message.resign = ResignResponse.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 102: {
                    ...
                    message.drawOffer = DrawOfferResponse.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 103: {
                    ...
                    message.passTurn = PassTurnResponse.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
                ...
                case 104: {
                    ...
                    message.gameStart = GameStartResponse.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
    ...
    fromJSON(object: any): ServerToClient {
        return {
            ...
            usersInfo: isSet(object.usersInfo)
                ...
                : undefined,
            coordinate: isSet(object.coordinate)
                ? ChaksuResponse.fromJSON(object.coordinate)
                : undefined,
            resign: isSet(object.resign)
                ? ResignResponse.fromJSON(object.resign)
                : undefined,
            drawOffer: isSet(object.drawOffer)
            ...
            passTurn: isSet(object.passTurn)
                ...
                : undefined,
            gameStart: isSet(object.gameStart)
                ? GameStartResponse.fromJSON(object.gameStart)
                : undefined,
        };
    },
    ...
    create<I extends Exact<DeepPartial<ServerToClient>, I>>(
        base?: I,
    ): ServerToClient {
        return ServerToClient.fromPartial(base ?? ({} as any));
    },
    fromPartial<I extends Exact<DeepPartial<ServerToClient>, I>>(
        object: I,
    ): ServerToClient {
        const message = createBaseServerToClient();
        ...
        message.gameState =
            object.gameState !== undefined && object.gameState !== null
                ? GameState.fromPartial(object.gameState)
                : undefined;
        message.usersInfo =
            object.usersInfo !== undefined && object.usersInfo !== null
