...
export default function BadukWaitingRoom() {
  ...
  const [gameSettings, setGameSettings] = useState({
    gameType: 'baduk',
    mainTime: 10800, // 180분 (3시간) = 10800초
    additionalTime: 5,
    byoyomiTime: 60,
    byoyomiCount: 3,
    useMainTime: true,
  ...
  return (
    <div className="min-h-screen text-white p-8" style={{ backgroundColor: '#0b0c10' }}>
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2" style={{ color: '#e8eaf0' }}>바둑 대기실</h1>
                    ...
                    <div>
                      ...
                      {gameSettings.useMainTime && (
                        <input
                          ...
                          style={{
                            background: `linear-gradient(to right, #1f6feb 0%, #1f6feb ${(gameSettings.mainTime / 28800) * 100}%, #2a2a33 ${(gameSettings.mainTime / 28800) * 100}%, #2a2a33 100%)`,
