...
export default function OmokQuickMatch() {
  ...
  const [opponent, setOpponent] = useState({ name: '상대방', rating: 1200 });
  const [roomCode, setRoomCode] = useState('');

  // Add missing state declarations that are used in the code
  ...
  useEffect(() => {
    if (gameState === 'matching') {
      ...
      const timer = setTimeout(() => {
        ...
        setRoomCode(`OM${Math.random().toString(36).substr(2, 6).toUpperCase()}`);
        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-88px)] p-8">
          ...
          >
            <div className="mb-6">
              ...
              ></div>
              <h3 className="text-2xl font-bold mb-2" style={{ color: '#e8eaf0' }}>
                상대방 찾는 중...
              </h3>
        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-88px)] p-8">
          ...
          >
            <div className="mb-6">
              ...
              <p className="mt-4" style={{ color: '#9aa1ad' }}>
                곧 게임이 시작됩니다...
              </p>
            </div>
          </div>
